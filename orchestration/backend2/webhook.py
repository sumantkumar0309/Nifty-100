"""Webhook Delivery System - Send webhooks with exponential backoff retry logic"""
...
def send_webhook_with_retry(
    ...
    Args:
        ...
        base_backoff_seconds: Base backoff in seconds
    
    Returns:
        Dictionary with success status and delivery details
    """
    ...
    for attempt in range(1, attempts + 1):
        try:
            ...
            if 200 <= response.status_code < 300:
                ...
                logger.info(
                    "Webhook dispatched",
                    extra={"event": "webhook_success", "extra_data": result},
                )
                return result
    ...
    logger.error(
        ...
        extra={"event": "webhook_failure", "extra_data": result},
    )
    return result
