"""Celery App Configuration - Initialize Celery with Redis broker and beat schedule"""
...
celery_app.conf.beat_schedule = {
    "run-etl-pipeline-daily": {
        ...
        "schedule": crontab(
            hour=CELERY_BEAT_CRON["etl_daily_hour"],
            minute=CELERY_BEAT_CRON["etl_daily_minute"],
        ),
    },
