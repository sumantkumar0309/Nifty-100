...
1. Z-score method: Identifies outliers beyond 3 standard deviations
2. Isolation Forest: ML-based anomaly detection algorithm

Anomalies are flagged across:
- sales, net_profit, borrowings, operating_profit across years per company
"""
...
def detect_anomalies_zscore() -> dict[str, Any]:
    ...
    try:
        ...
        SELECT 
            company_id, year,
            sales, net_profit, operating_profit, interest
...
def detect_anomalies_isolation_forest() -> dict[str, Any]:
    """
    Isolation Forest anomaly detection: ML-based unsupervised learning approach.
